...
LevSel_Level_SS:
		...
		move.b	#9,(v_lives).w	; set lives to 3
		moveq	#0,d0
		move.w	d0,(v_rings).w	; clear rings
		move.l	d0,(v_time).w	; clear time
		move.l	d0,(v_score).w	; clear score
		if Revision<>0
			move.l	#1,(v_scorelife).w ; extra life is awarded at 50000 points; now with 100 points! :D
		endif
		rts	
; ===========================================================================
...
PlayLevel:
		...
		if Revision<>0
			move.l	#1,(v_scorelife).w ; extra life is awarded at 50000 points. now with every 100 points!
		endif
		move.b	#bgm_Fade,d0
...
Demo_Level:
		...
		move.l	d0,(v_score).w	; clear score
		if Revision<>0
			move.l	#1,(v_scorelife).w ; extra life is awarded at 50000 points now with every 100!
		endif
		rts	
; ===========================================================================
; ---------------------------------------------------------------------------
...
.belowmax:
			...
			addi.l  #1,(v_scorelife).w ; increase requirement by 50000 now with every 100!
			tst.b   (v_megadrive).w
