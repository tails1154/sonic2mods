...
;-------------------------------------------------------------------------------
                moveq   #$0E, D1
                move.l  A2, A3           ; Copy A2 to A3
                add.l   #$FBA0, A3       ; Add the offset to A3
                lea     (A3), A2         ; Load the address into A2
...
Menu_Clear_Act_x:                                               ; Limpa os números dos acts não usados e carrega o "*" do Sound Test
                ...
                move.l  A2, A3           ; Copy A2 to A3
                add.l   #$FF10, A3       ; Add the offset to A3
                lea     (A3), A2         ; Load the address into A2
...
;------------------------------------------------------------------------------- 
                ...
                move.w  #$0000, ($FFFFF7B8).w  ; Use a properly aligned address
...
Menu_Code_Test:
                ...
                move.w  #$0101, (A1)
;                 jmp     Menu_All_Emeralds_Code_TestTwo
...
Menu_All_Emeralds_Code_TestTwo:
                move.w  ($FFFFFF0E).w, D0
                adda.w  D0, A2
                move.w  ($FFFFFF84).w, D0
                cmp.b   (A2), D0
                bne.s   Menu_Reset_All_Emerald_Code_CounterTwo
                addq.w  #$01, ($FFFFFF0E).w
                tst.b   $0001(A2)
                bpl.s   Menu_Code_Not_0xFF
                tst.w   D2
                bne.s   Menu_Set_All_EmeraldsTwo
Menu_Set_Debug_Flag:
...
Menu_Set_All_Emeralds:
                ...
                bsr     Menu_Play_Music
Menu_Set_All_EmeraldsTwo:
;                 move.w  #$0006, ($FFFFFE56).w
                move.b  #Emerald_Snd, D0
                bsr     Menu_Play_Music
Menu_Reset_All_Emerald_Code_Counter:
                move.w  #$0000, ($FFFFFF0E).w
Menu_Reset_All_Emerald_Code_CounterTwo:
                move.w  #$0000, ($FFFFFF0E).w
Menu_Code_Not_0xFF:
                rts
Code_Debug_Mode:
